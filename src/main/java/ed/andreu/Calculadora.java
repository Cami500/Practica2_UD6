...
/** Esta clase tiene la función de crear un objeto que realize las funciones de una calculadora.
 * @author andreu
 * @version 3.7
 ...
 * de todo tipo, los calculos en esta clase se harán a partir de los parametros introducidos
 * @author andreu
 * @version 3.7
 * @since 2.1, junio de 2022
 */
